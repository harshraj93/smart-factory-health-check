...
function FormNavigationButton(props){
    return(
        <button type="submit" disabled={props.disabled} className={"form-navigation-button "+props.buttonStatus} onClick={props.onClick} value={props.labelName} style={props.style}>{props.labelName}</button>
    )
}
